...
> \Cakemail\Model\CreateTestEmailResponse createTestEmail($campaign_id, $test_email, $account_id)
...
$campaign_id = 56; // int | 
$test_email = new \Cakemail\Model\TestEmail(); // \Cakemail\Model\TestEmail | 
$account_id = 56; // int | 

try {
    $result = $apiInstance->createTestEmail($campaign_id, $test_email, $account_id);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **campaign_id** | **int**|  |
 **test_email** | [**\Cakemail\Model\TestEmail**](../Model/TestEmail.md)|  |
