...
class LogoApi
{
     ...
     *
     * @param  \Cakemail\Model\UploadLogo $upload_logo upload_logo (required)
     * @param  int $account_id account_id (optional)
     *
     * @throws \Cakemail\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cakemail\Model\UploadLogoResponse|\Cakemail\Model\HTTPBadRequestError|\Cakemail\Model\HTTPValidationError
     */
     ...
     * Upload a default logo
     *
     * @param  \Cakemail\Model\UploadLogo $upload_logo (required)
     * @param  int $account_id (optional)
     *
     * @throws \Cakemail\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cakemail\Model\UploadLogoResponse|\Cakemail\Model\HTTPBadRequestError|\Cakemail\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadDefaultLogoWithHttpInfo($upload_logo, $account_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cakemail\Model\UploadLogoResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Cakemail\Model\UploadLogoResponse', []),
            ...
            $returnType = '\Cakemail\Model\UploadLogoResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cakemail\Model\UploadLogoResponse',
